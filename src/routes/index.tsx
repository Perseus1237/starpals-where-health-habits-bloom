        ...
        <div className="relative z-10 mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              StarPals turns care plans into magical daily quests so kids feel like heroes instead of patients, parents stop being the nagging system, and care teams get useful signal between visits.
            </p>
        ...
        <div className="mx-auto grid max-w-6xl gap-4 md:grid-cols-3">
          {modules.map((module) => {
            ...
            return (
              ...
              >
                <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-2xl ${module.tone}`}>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
              StarPals works because it creates value for the child, the caregiver, and the care team at the same time. Each role gets the right surface, language, and level of detail.
            </p>
          </div>
      ...
      <section className="relative z-10 px-5 py-14 sm:px-8">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
              Millions of children live with chronic health needs and a daily choreography of puffs, pills, stretches, hydration, mood checks, breathing, rest, and appointments. The system sees adherence. The child feels boredom, worry, isolation, and pressure.
            </p>
          </div>
      ...
      <section className="relative z-10 px-5 py-14 sm:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
              StarPals inverts the frame. The child is not a tiny adult managing a diagnosis. The child is a caretaker whose small daily actions feed a creature, restore a world, unlock a story, and light a constellation with other brave kids.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                The product architecture is simple on the surface and clinically useful underneath: plan, translate, play, summarize.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                The wedge starts with simple Care Cards. The platform expands into clinic-approved care-plan templates, FHIR and SMART launch workflows, parent approval gates, child-safe AI storytelling, and provider summaries that respect privacy from day one.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                The mission only works if families trust the product. StarPals keeps the child experience playful and non-clinical while putting approval, privacy, and governance around the care layer.
              </p>
            </div>
      ...
      <section className="relative z-10 px-5 py-14 sm:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
            StarPals is not a medical device, a diagnosis engine, or a social feed. It is a mission-driven care companion built to lower friction at home, preserve childhood, and help clinical teams see what families carry between visits.
          </p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link to={childTarget} className="btn-magical inline-flex items-center justify-center gap-2">
...
function FloatingSignal({
  ...
  return (
    <div className={`absolute glass-card rounded-2xl px-4 py-3 shadow-[var(--shadow-card)] ${className}`}>
